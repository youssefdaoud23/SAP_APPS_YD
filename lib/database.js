  ...
  initPromise = (async () => {
    ...
    try {
      ...
      await client.query(`
        ...
        CREATE TABLE IF NOT EXISTS platform_api_definitions (
        ...
        CREATE TABLE IF NOT EXISTS platform_api_operations (
          operation_id TEXT PRIMARY KEY,
          api_id TEXT NOT NULL REFERENCES platform_api_definitions(api_id) ON DELETE CASCADE,
          method TEXT NOT NULL,
          path TEXT NOT NULL,
          summary TEXT NOT NULL DEFAULT '',
          description TEXT NOT NULL DEFAULT '',
          mode TEXT NOT NULL DEFAULT 'sap-proxy',
          connection_id TEXT,
        ...
        CREATE INDEX IF NOT EXISTS idx_platform_api_operations_api ON platform_api_operations(api_id, method, path);
      `);
