...
const PERMISSIONS = Object.freeze([
  ...
  { key: 'functions.manage', description: 'Create and administer server functions' },
...
const ROLES = Object.freeze([
  ...
  { key: 'developer', name: 'Developer', description: 'Build and test applications, workflows, reusable APIs and server functions.', permissions: ['apps.view', 'apps.create', 'apps.edit', 'connections.view', 'workflows.manage', 'api.manage', 'functions.manage', 'audit.view'] },
