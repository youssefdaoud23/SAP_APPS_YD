...
const ROLES = Object.freeze([
  ...
  { key: 'developer', name: 'Developer', description: 'Build and test applications, reusable APIs and server functions.', permissions: ['apps.view', 'apps.create', 'apps.edit', 'connections.view', 'api.manage', 'functions.manage', 'audit.view'] },
